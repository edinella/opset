...
module.exports = OpsMap;
function OpsMap(alias, Structure) {
  this.setStructure(Structure);
  this.alias = alias || module.filename;
  this.debug = debug('OpsMap:' + this.alias);
}

OpsMap.prototype.setStructure = function(StructureToExtend) {
...
OpsMap.prototype.getStructure = function() {
  return this.Structure;
};

OpsMap.prototype.detectDependencies = function(fn) {
  var dependencies = [];
...
OpsMap.prototype.value = function(alias, value) {
  this.debug('Defining value "%s"', alias);
  this.Structure.prototype[alias] = value;
  return this;
};

OpsMap.prototype.getFunctionSignature = function(fn) {
  var fnText = fn.toString().replace(STRIP_COMMENTS, '');
...
OpsMap.prototype.run = function(fn, path) {
  ...
  deferred.promise.then(function() {
    component.debug('"%s" OK', PATH);
  });
  deferred.promise.fail(function(err) {
    component.debug('"%s" ERROR', PATH, err.stack);
  });
  return deferred.promise;
};
